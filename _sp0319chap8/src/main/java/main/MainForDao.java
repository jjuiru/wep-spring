...
public class MainForDao {
	...
	public static void main(String[] args) {
		...
		Member member2 = new Member("leegh1@leegh", "1234", "leegh", null); // insert test
		dao.insert(member2);
		LOGGER.info("한 행이 입력되었습니다.");
		LOGGER.info("새로 입력된 회원의 ID:{}", member2.getId()); // 아이디를 받아 바로 객체에 저장해온다. 
		
		Member member3 = new Member("lee@lee", "1234", "이지현", null); // insert test
		dao.update(member3);
		LOGGER.info("업데이트 성공입니다.");
