...
<main class="form-signin w-100 m-auto">
  <form action="list.jsp" method="post">
    <img class="mb-4" src="assets/brand/easel.svg" alt="" width="72" height="57">
    ...
    <button class="btn btn-dark w-100 py-2" type="submit" onclick="location.href='list.jsp';">Sign in</button>
